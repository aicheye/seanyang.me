...
import { ExternalLinkIcon, GitHubIcon, InstagramIcon, LetterboxdIcon, LinkedInIcon, TwitterIcon } from "./Icons";
import Tooltip from "./Tooltip";

export default function Footer({ co2 = "0.03", percentage = "93", url = "", hideLinks = false }) {
  ...
  return (
    <>
      <footer className="py-8 flex flex-col items-center gap-2 sm:gap-4 z-10">
        {!hideLinks && (
          <div id="contact" className="flex lg:flex-row md:flex-row flex-col lg:gap-4 md:gap-4 gap-1 items-center" style={{ color: "var(--page-text)" }}>
        ...
        <div className="flex flex-row gap-4 items-center">
          ...
          <span>·</span>
          <a href="https://docs.seanyang.me/" target="_blank" rel="noopener noreferrer" className="underline text-lg flex items-center gap-2">
            <div className="flex items-center justify-center gap-2" style={{ height: "32px" }}>
              Docs <ExternalLinkIcon className="w-6 h-6" />
            </div>
          </a>
        </div>
