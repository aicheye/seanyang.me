  ...
  return (
    <span>
      ...
      <a href="https://se-webring.xyz/" target="_blank" rel="noopener noreferrer" onMouseEnter={() => handleMouseEnter("⭕ Visit webring")} onMouseLeave={handleMouseLeave} aria-label="SE Webring">
        {isLightMode ? <img src="/webring_logo_b.svg" alt="SE Webring" className="inline lg:h-6 md:h-6 h-5.25 pb-1.5 pt-0.5" /> : <img src="/webring_logo_w.svg" alt="SE Webring" className="inline lg:h-6 md:h-6 h-5.25 pb-1.5 pt-0.5" />}
      </a>{" "}
